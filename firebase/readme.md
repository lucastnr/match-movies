...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp firebase` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run firebase:deploy` - Deploy this app to firebase
* `nx run firebase:serve` - Serve this app using the firebase emulator
* `nx run firebase:build` - Build all functions associated with this app
* `nx run firebase:test` - Test all functions associated with this app
* `nx run firebase:lint` - Lint all functions associated with this app
